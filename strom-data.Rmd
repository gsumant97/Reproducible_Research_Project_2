---
title: "Analysis of Economic and Popoulation Healt Impact of Historical Strom Events"
author: "Sumant"
date: "12/08/2020"
output: 
  html_document:
...
[github repository](https://github.com/gsumant97/Reproducible_Research_Project_2)
...
*[Results](#results)
  ...
  *[Event Type with Greatest Economic Consequences](#event-types-with-greatest-economic-consequences)
...
sd$EventType <- 'UNCATEGORIZED' #start all EventType off as "Uncategorized"
```
...
coastalFloodAliases <- c('ASTRONOMICAL HIGH TIDE', 'TIDAL FLOODING', 'COASTAL FLOODING/EROSION', 'COASTAL FLOODING/EROSION', 'EROSION/CSTL FLOOD')
